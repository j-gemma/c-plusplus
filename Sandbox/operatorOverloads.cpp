...
void handleBadFraction() {
  std::cin.clear();
  std::cin.ignore(std::numeric_limits<std::streamsize>::max(), '\n');
  std::cout << "Invalid input. Try again (format: a/b): ";
}
...
std::string_view MyString::operator()(int startIdx, int len) {
  ...
  return std::string_view{m_str}.substr(static_cast<size_t>(startIdx),
